...
// Looks like a file path: extensions or / with non-URL context.
// The extension alternative requires a trailing word boundary so "weather.com"
// does not spuriously match ".c" from the C-extension alternative.
